...
export default function Tracks() {
  ...
  function handleEdit(tracks) {
    navigate("/createTracks", { state: { tracks } });
  }
    ...
    <div>
      ...
      <main className="bg-gray-900 min-h-screen p-5 flex gap-5">
        ...
        <div className="flex-1 bg-gray-800 rounded-lg">
          ...
          <h1 className="text-4xl font-bold text-purple-500">Tracks</h1>
            <Link
              to="/createTracks"
            ...
            <tbody>
              {tracks.map((t,index) => (
                <tr key={t.id}>
                  ...
                  <td className="p-2 border">{t.genre?.genre ?? "Unknown Genre"}</td>
